...
public class Version implements Comparable<Version> {
	...
	if (object instanceof String) {
	    ...
	    String msg = Message.getMessage(Message.ERROR_VERSION_CLASS, object.getClass().getName());
	...
	for (int i=0; i < len; i++) {
		...
		if (sb.length() > 0) {
		    ...
		    throw new IllegalArgumentException(Message.getMessage(Message.ERROR_VERSION_STR, str));
		}
		break;
	    }
	}
